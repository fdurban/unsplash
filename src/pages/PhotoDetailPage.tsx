  ...
  return (
    <>
      <div className="flex flex-col content-center mt-6">
        {photoUrl ? (
          <>
            <img src={photoUrl} alt={`Image ${id}`} className="w-auto h-auto mx-8 my-8 rounded" />
            <div className="pl-8">
              ...
              <button onClick={() => setOpen(true)} className="mt-4 hover:bg-gray-300 rounded p-1">+  Add to Collection</button>
            ...
            <div className="pl-8">
              ...
              <ul>
                {collections.map((collection) => (
                  <li key={collection.id} className="flex items-center my-4 hover:bg-slate-100">
                    <img src={collection.cover_photo.urls.raw} alt="" className="w-16 h-16 rounded-md" />
                    <div className="pl-4">
